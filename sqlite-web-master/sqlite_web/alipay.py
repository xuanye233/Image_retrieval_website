...
app_private_key_path = os.path.join('./static', 'alipay/ying_yong_si_yao.txt')
alipay_public_key_path = os.path.join('./static', 'alipay/zhi_fu_bao_gong_yao.txt')
...
if __name__ == "__main__":
    ...
    url = alipay.direct_pay(
        ...
        return_url="http://112.74.55.3/result/",          # 支付成功后，跳转url
    )
